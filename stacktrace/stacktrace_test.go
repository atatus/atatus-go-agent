...
func TestStacktrace(t *testing.T) {
	expect := []string{
		"go.atatus.com/agent/stacktrace_test.callPanickerDefer",
		"runtime.gopanic",
		"go.atatus.com/agent/stacktrace_test.(*panicker).panic",
		"go.atatus.com/agent/stacktrace_test.callPanicker",
	}
...
func TestSplitFunctionName(t *testing.T) {
	...
	testSplitFunctionName(t, "main", "(*Foo).Bar")
	testSplitFunctionName(t, "go.atatus.com/agent/foo", "bar")
	testSplitFunctionName(t,
		"go.atatus.com/agent/module/atgin",
		"(*middleware).(go.atatus.com/agent/module/atgin.handle)-fm",
	)
}
