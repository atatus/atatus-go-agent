...
import (
	...
	"go.atatus.com/agent/module/athttprouter"
	"go.atatus.com/agent/transport/transporttest"
)

func TestRouterHTTPSuite(t *testing.T) {
	tracer, recorder := transporttest.NewRecorderTracer()
	router := athttprouter.New(athttprouter.WithTracer(tracer))
...
func sendRequest(r *athttprouter.Router, w http.ResponseWriter, method, path string) {
