...
package atgometrics // import "go.atatus.com/agent/module/atgometrics"
...
// as an atatus.MetricsGatherer.
func Wrap(r metrics.Registry) atatus.MetricsGatherer {
	return gatherer{r}
}
...
func (g gatherer) GatherMetrics(ctx context.Context, m *atatus.Metrics) error {
