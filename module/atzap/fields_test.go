...
func TestTraceContext(t *testing.T) {
	...
	tx, spans, _ := apmtest.WithTransaction(func(ctx context.Context) {
		...
		defer span.End()
		logger.With(atzap.TraceContext(ctx)...).Debug("beep")
		logger.Debug("beep", atzap.TraceContext(ctx)...)
	})
...
func TestTraceContextEmpty(t *testing.T) {
	...
	// atzap.TraceContext will return nil if the context does not contain a transaction.
