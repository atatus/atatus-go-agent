...
func TestMarshalErrorStack(t *testing.T) {
	...
	assert.Equal(t, "go.atatus.com/agent/module/atzerolog_test.funcC", record.Stack[0].Func)
	assert.Equal(t, "go.atatus.com/agent/module/atzerolog_test.funcB", record.Stack[1].Func)
	assert.Equal(t, "go.atatus.com/agent/module/atzerolog_test.funcA", record.Stack[2].Func)
