...
// generic modules (athttp and atgrpc) are sufficient.
//
// Go kit-based HTTP servers can be traced by instrumenting
// the kit/transport/http.Server with athttp.Wrap, and HTTP
// clients can be traced by providing a net/http.Client
// instrumented with athttp.WrapClient.
//
// Go kit-based gRPC servers and clients can both be wrapped
// using the interceptors provided in module/atgrpc.
package atgokit // import "go.atatus.com/agent/module/atgokit"
