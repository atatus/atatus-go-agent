...
func (s *apmSQS) setAdditional(span *atatus.Span) {
...
func addMessageAttributesSQS(req *request.Request, span *atatus.Span, propagateLegacyHeader bool) {
...
func setTracingAttributes(
	...
	attrs[athttp.W3CTraceparentHeader] = value
	if propagateLegacyHeader {
		attrs[athttp.AtatusTraceparentHeader] = value
	}
	if tracestate != "" {
		attrs[athttp.TracestateHeader] = &sqs.MessageAttributeValue{
			DataType:    aws.String("String"),
