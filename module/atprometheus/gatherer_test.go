...
import (
	...
	"go.atatus.com/agent/module/atprometheus"
)

func TestGoCollector(t *testing.T) {
	g := atprometheus.Wrap(prometheus.DefaultGatherer)
...
func gatherMetrics(g atatus.MetricsGatherer) []model.Metrics {
