...
package testservice // import "go.atatus.com/agent/module/atgrpc/internal/testservice"
...
func init() {
	proto.RegisterType((*AccumulateRequest)(nil), "go.atatus.com.agent.module.atgrpc.testservice.AccumulateRequest")
	proto.RegisterType((*AccumulateReply)(nil), "go.atatus.com.agent.module.atgrpc.testservice.AccumulateReply")
}
...
func (c *accumulatorClient) Accumulate(ctx context.Context, opts ...grpc.CallOption) (Accumulator_AccumulateClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Accumulator_serviceDesc.Streams[0], "/go.atatus.com.agent.module.atgrpc.testservice.Accumulator/Accumulate", opts...)
	if err != nil {
		return nil, err
	}
...
var _Accumulator_serviceDesc = grpc.ServiceDesc{
	ServiceName: "go.atatus.com.agent.module.atgrpc.testservice.Accumulator",
