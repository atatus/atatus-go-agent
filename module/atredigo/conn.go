...
package atredigo // import "go.atatus.com/agent/module/atredigo"
...
// Wrap wraps conn such that its Do method calls atredigo.Do with
...
// will similarly call atredigo.DoWithTimeout.
//
...
// Do calls conn.Do(commandName, args...), and also reports the operation as a span to Atatus.
func Do(ctx context.Context, conn redis.Conn, commandName string, args ...interface{}) (interface{}, error) {
	...
	span, _ := atatus.StartSpan(ctx, spanName, "db.redis")
	defer span.End()
	return conn.Do(commandName, args...)
}

// DoWithTimeout calls redis.DoWithTimeout(conn, timeout, commandName, args...), and also reports the operation as a span to Atatus.
