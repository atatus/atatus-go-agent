...
func TestBreakdownMetrics_NonSampled(t *testing.T) {
	...
	t0 := time.Now()
	tx := tracer.StartTransactionOptions("test", "request", atatus.TransactionOptions{Start: t0})
	span := tx.StartSpanOptions("whatever", "db.mysql", atatus.SpanOptions{Start: t0.Add(10 * time.Millisecond)})
...
func TestBreakdownMetrics_AcceptanceTest3(t *testing.T) {
	...
	t0 := time.Now()
	tx := tracer.StartTransactionOptions("test", "request", atatus.TransactionOptions{Start: t0})
	span := tx.StartSpanOptions("whatever", "app", atatus.SpanOptions{
...
func TestBreakdownMetrics_AcceptanceTest4(t *testing.T) {
	...
	t0 := time.Now()
	tx := tracer.StartTransactionOptions("test", "request", atatus.TransactionOptions{Start: t0})
	span1 := tx.StartSpanOptions("whatever", "db.mysql", atatus.SpanOptions{Start: t0.Add(10 * time.Millisecond)})
	span2 := tx.StartSpanOptions("whatever", "db.mysql", atatus.SpanOptions{Start: t0.Add(10 * time.Millisecond)})
...
func TestBreakdownMetrics_AcceptanceTest5(t *testing.T) {
	...
	tx := tracer.StartTransactionOptions("test", "request", atatus.TransactionOptions{Start: t0})
	span1 := tx.StartSpanOptions("whatever", "db.mysql", atatus.SpanOptions{Start: t0.Add(10 * time.Millisecond)})
	span2 := tx.StartSpanOptions("whatever", "db.mysql", atatus.SpanOptions{Start: t0.Add(15 * time.Millisecond)})
	span1.Duration = 10 * time.Millisecond // t0 + 20ms
...
func TestBreakdownMetrics_AcceptanceTest6(t *testing.T) {
	...
	t0 := time.Now()
	tx := tracer.StartTransactionOptions("test", "request", atatus.TransactionOptions{Start: t0})
	span1 := tx.StartSpanOptions("whatever", "db.mysql", atatus.SpanOptions{Start: t0.Add(5 * time.Millisecond)})
...
func TestBreakdownMetrics_AcceptanceTest7(t *testing.T) {
	...
	span1.End()
	span2 := tx.StartSpanOptions("whatever", "db.mysql", atatus.SpanOptions{Start: t0.Add(20 * time.Millisecond)})
...
func TestBreakdownMetrics_AcceptanceTest8(t *testing.T) {
	...
	span1, ctx := atatus.StartSpanOptions(ctx, "whatever", "app", atatus.SpanOptions{Start: t0.Add(10 * time.Millisecond)})
	span2, ctx := atatus.StartSpanOptions(ctx, "whatever", "db.mysql", atatus.SpanOptions{Start: t0.Add(15 * time.Millisecond)})
	span1.Duration = 10 * time.Millisecond // t0 + 20ms
	span2.Duration = 10 * time.Millisecond // t0 + 25ms
	span1.End()
	span2.End()
...
func TestBreakdownMetrics_AcceptanceTest9(t *testing.T) {
	...
	tx.End()
	span2, ctx := atatus.StartSpanOptions(ctx, "whatever", "db.mysql", atatus.SpanOptions{Start: t0.Add(20 * time.Millisecond)})
...
func TestBreakdownMetrics_AcceptanceTest11(t *testing.T) {
	...
	tx.End()
	span := tx.StartSpanOptions("whatever", "db.mysql", atatus.SpanOptions{Start: t0.Add(20 * time.Millisecond)})
