...
import (
	...
	"go.atatus.com/agent/internal/apmcloudutil"
	"go.atatus.com/agent/internal/apmhostutil"
	"go.atatus.com/agent/internal/apmlog"
	"go.atatus.com/agent/internal/apmstrings"
...
const (
	envHostname        = "ATATUS_HOSTNAME"
	envServiceNodeName = "ATATUS_SERVICE_NODE_NAME"
