...
// RecordingTracer holds an atatus.Tracer and transporttest.RecorderTransport.
type RecordingTracer struct {
	*atatus.Tracer
	transporttest.RecorderTransport
}

// WithTransaction calls rt.WithTransactionOptions with a zero atatus.TransactionOptions.
func (rt *RecordingTracer) WithTransaction(f func(ctx context.Context)) (model.Transaction, []model.Span, []model.Error) {
	return rt.WithTransactionOptions(atatus.TransactionOptions{}, f)
}
...
func (rt *RecordingTracer) WithTransactionOptions(opts atatus.TransactionOptions, f func(ctx context.Context)) (model.Transaction, []model.Span, []model.Error) {
