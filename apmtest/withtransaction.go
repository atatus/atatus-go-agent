...
func WithTransaction(f func(ctx context.Context)) (model.Transaction, []model.Span, []model.Error) {
	return WithTransactionOptions(atatus.TransactionOptions{}, f)
}
...
func WithTransactionOptions(opts atatus.TransactionOptions, f func(ctx context.Context)) (model.Transaction, []model.Span, []model.Error) {
