...
func TestTracerCPUProfiling(t *testing.T) {
	os.Setenv("ATATUS_CPU_PROFILE_INTERVAL", "100ms")
	os.Setenv("ATATUS_CPU_PROFILE_DURATION", "1s")
	defer os.Unsetenv("ATATUS_CPU_PROFILE_INTERVAL")
	defer os.Unsetenv("ATATUS_CPU_PROFILE_DURATION")
...
func TestTracerHeapProfiling(t *testing.T) {
	os.Setenv("ATATUS_HEAP_PROFILE_INTERVAL", "100ms")
	defer os.Unsetenv("ATATUS_HEAP_PROFILE_INTERVAL")
