...
package model // import "go.atatus.com/agent/model"
...
type Service struct {
	...
	// Agent holds information about the Atatus agent tracing this
...
// Agent holds information about the Atatus agent.
type Agent struct {
	// Name is the name of the Atatus agent, e.g. "Go".
	Name string `json:"name"`

	// Version is the version of the Atatus agent, e.g. "1.0.0".
