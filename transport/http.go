...
import (
	...
	"go.atatus.com/agent/internal/apmversion"
...
const (
	...
	envAPIKey           = "ATATUS_API_KEY"
	envSecretToken      = "ATATUS_SECRET_TOKEN"
	envServerURLs       = "ATATUS_SERVER_URLS"
	envServerURL        = "ATATUS_SERVER_URL"
	envServerTimeout    = "ATATUS_SERVER_TIMEOUT"
	envServerCert       = "ATATUS_SERVER_CERT"
	envVerifyServerCert = "ATATUS_VERIFY_SERVER_CERT"
	envCACert           = "ATATUS_SERVER_CA_CERT_FILE"
)
...
//
// This overrides the value specified via the ATATUS_SECRET_TOKEN or
// ATATUS_API_KEY environment variables, if either are set.
...
// initServerURLs parses ATATUS_SERVER_URLS if specified,
// otherwise parses ATATUS_SERVER_URL if specified. If
...
func defaultUserAgent() string {
	return fmt.Sprintf("atatus-go/%s go/%s", apmversion.AgentVersion, runtime.Version())
}
